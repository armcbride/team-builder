  ...
  create a team page with employee information with Node
  <hr>
  <div id="install"><h3>Installation</h3> </div>
  <p>json package included</p>
  <hr>
  <div id="tech"><h3>Technology</h3></div>           
  <p> HTML, CSS, Bootstrap,Node.Js, JavaScript</p>
  <hr>
  <div id="use"><h3>Usage</h3></div>
  <p>Easily create a webpage with team information with node.</p>  
  <hr>
